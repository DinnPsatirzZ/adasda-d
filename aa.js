...
module.exports = dinn = async (dinn, m, chatUpdate, store) => {
    try {
        ...
        const ppdefault = 'https://icon-library.com/images/no-profile-picture-icon/no-profile-picture-icon-15.jpg'
        const ppgcdefault = 'https://image.winudf.com/v2/image/Y29tLmFwcC53aGF0c2FwcC5kcC5wcm9maWxlLnBpYy5kb3dubG9hZC5zYXZlcl9pY29uXzBfYTRmYmNhODM/icon.png?w=&fakeurl=1'
